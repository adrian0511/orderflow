package com.adrian.paymentservice.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "payment-group");
        properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        Map<String, String> typeMappings = Map.of(
                "com.adrian.orderservice.dto.event.OrderStockReservedEvent", "com.adrian.paymentservice.dto.event.OrderStockReservedEvent"
        );
